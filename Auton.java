...
"";
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) 
        {
            ...
            grab();
            moveLift(200);
            while(lift.isBusy()){sleep(100);}
            straight(100, 800);
            while(leftFrontDrive.isBusy()){sleep(100);}
            sleep(250);
            turnToLeft(1000);
            while(leftFrontDrive.isBusy()){sleep(100);}
            straight(1650, 800);
    ...
    {
        if (!leftFrontDrive.isBusy() && !leftBackDrive.isBusy() && !rightFrontDrive.isBusy() && !rightBackDrive.isBusy() && !lift.isBusy())
        {
            return true;
        }
        return false;
